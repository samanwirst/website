...
export function HeroSection({ style }: HeroSectionProps) {
  return (
    <section
      className='reveal grid grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] gap-4 text-[var(--section-text,var(--text))] [--section-text:var(--ink)] [--section-muted:var(--ink-muted)] max-[1000px]:grid-cols-1'
      style={style}
    >
      <article className='rounded-[var(--radius-xl)] border-2 border-[color:var(--line)] bg-[var(--surface)] p-[clamp(1.4rem,2.8vw,2.5rem)] max-[700px]:rounded-[var(--radius-lg)]'>
      ...
      <aside className='flex flex-col gap-[0.85rem] rounded-[var(--radius-xl)] border-2 border-[color:var(--line)] bg-[var(--surface)] p-[1.2rem] max-[700px]:rounded-[var(--radius-lg)]'>
        ...
        <ul className='m-0 grid list-none gap-[0.55rem] p-0'>
          <li className='flex items-center justify-between gap-[0.8rem] rounded-[var(--radius-md)] border-2 border-[color:var(--line)] bg-[var(--surface-strong)] px-[0.7rem] py-[0.6rem] transition-[border-color,background-color] duration-[120ms] linear hover:border-[color:var(--line-strong)] hover:bg-[var(--surface-soft)]'>
