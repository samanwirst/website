...
export const sectionTitle =
  'mt-[0.35rem] text-[clamp(1.55rem,3vw,2.5rem)] leading-[1.08] tracking-[-0.02em] [font-family:var(--font-display),Trebuchet_MS,sans-serif] max-[700px]:text-[clamp(1.3rem,6.8vw,1.9rem)]';
export const sectionSummary =
  'mt-[0.65rem] max-w-[66ch] leading-[1.5] text-[var(--section-muted,var(--muted))] max-[480px]:text-[0.9rem]';
